...
interface SQAModalProps {
  survey: any;
  setSelectedUser: Dispatch<SetStateAction<null>>;
}
const SQAModal = ({ setSelectedUser, survey }: SQAModalProps) => {
  const profileData = [
        ...
        <DialogTrigger>
          <button className=" cursor-pointer">
            <Eye
              ...
              onClick={() => {
                setSelectedUser(survey);
              }}
            />
          </button>
        </DialogTrigger>
        <DialogContent className="!max-w-[700px] w-full">
          <section className="flex items-center font-sora justify-between mt-6">
